...
const Pricing = () => {
  return (
    <section id="pricing" className="py-20 px-4 bg-gradient-to-r from-[#C14444] to-[#E47777] text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <Card className="bg-white/10 backdrop-blur-sm transform scale-105 border-2 border-white">
            <CardHeader className="text-white">
              ...
              <p className="text-sm mt-2 font-bold text-green-400">15% de desconto no total</p>
            </CardHeader>
            <CardContent className="text-left">
              <ul className="space-y-2">
                <li>✅ Todas as funcionalidades</li>
          ...
          <Card className="bg-white/10 backdrop-blur-sm">
            <CardHeader className="text-white">
              ...
              <p className="text-sm mt-2 font-bold text-green-400">40% de desconto no total</p>
            </CardHeader>
            <CardContent className="text-left">
              <ul className="space-y-2">
                <li>✅ Todas as funcionalidades</li>
