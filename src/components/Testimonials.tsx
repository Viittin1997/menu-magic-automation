      ...
      <div className="container mx-auto max-w-6xl px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <p className="font-semibold text-primary">João Silva - Pizzaria do João</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <p className="font-semibold text-primary">Maria Santos - Hamburgueria M.S</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <p className="font-semibold text-primary">Pedro Costa - Marmitaria do Pedro</p>
          </div>
        </div>
      </div>
    </section>
